...
import IPython
from .simgr_helper import overflow_detect_filter, hook_win, hook_four,hook_execve
import logging
...
def checkOverflow(binary_name, inputType="STDIN"):
    ...
    p.hook_symbol("execve", hook_execve())
...
def get_win_input(binary_name, inputType="STDIN"):
    # print("test")
    extras = {
        so.REVERSE_MEMORY_NAME_MAP,
        so.TRACK_ACTION_HISTORY,
